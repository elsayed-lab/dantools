...
Bio::Dantools::pseudogen(base => "$start_dir/base.fasta",
                         ...
                         no_fragment => 0,
                         scoremin => 'L,0,-1.50',
                         readsu => "$start_dir/paired_1.fastq"
    );
...
my $exp_vcf = File::Slurp::read_file("${start_dir}/exp_unpaired_vars.vcf");
...
my $exp_depth = File::Slurp::read_file("${start_dir}/exp_unpaired_depth.tsv");
